...
FEEDBACK: [1-2 sentences of direct, actionable feedback. Point out if they missed complexity.]`;
      ...
      if (typeof CodeMirror !== 'undefined') {
        setTimeout(() => {
          cmInstance = CodeMirror.fromTextArea(document.getElementById("aiCodeEditor"), {
            lineNumbers: true,
            mode: "text/x-c++src",
            theme: "neo",
            indentUnit: 4,
      ...
      const chatInp = document.getElementById("aiChatInput");
      const sendBtn = document.getElementById("aiSendBtn");
      const micBtn = document.getElementById("aiMicBtn");
      const runBtn = document.getElementById("aiDryRunBtn");
      ...
      const sendToGemini = async (userText, isCodeRun = false) => {
         ...
         const codeSnapshot = cmInstance ? cmInstance.getValue() : document.getElementById("aiCodeEditor").value;
